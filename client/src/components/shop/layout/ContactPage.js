                                ...
                                <div className="w-full 2xl:pl-48 xl:pt-1">
                                    ...
                                    <div className="w-full md:w-10/12 mt-3">
                                        ...
                                        <div className="mt-4 md:mt-8">
                                            ...
                                            <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">147/E Green Road, Level-3, Laila Lodge, Dhaka-1215  </h2>
                                        </div>
                                        <div className="mt-4 md:mt-8">
                                            <h2 className="text-sm md:text-base text-indigo-700 font-semibold">Contact</h2>
                                            <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">                +8802 9101073
</h2>
                                            <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">                +8802 9101073
</h2>
                                        </div>
                                        <div className="mt-4 md:mt-8">
                                            ...
                                            <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">                info@i2gether.com
</h2>
                                        </div>
                                    </div>
                                </div>
...
const contactPage = (props) => {
  return <Layout children={<ContactUs />} />;
};
