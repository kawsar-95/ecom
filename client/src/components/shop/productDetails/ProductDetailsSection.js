...
import { ProductContext } from "../../admin/products";
    ...
    try {
      ...
      setTimeout(() => {
        if (responseData.Product) {
          setProductObject(responseData.Product);
          layoutDispatch({
      ...
      <section className="m-4 md:mx-12 md:my-6">
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="hidden md:block md:col-span-1 md:flex md:flex-col md:space-y-4 md:mr-2">
            <img
              ...
              className={`${count === 0 ? "" : "opacity-25"
                } cursor-pointer w-20 h-20 object-cover object-center rounded-lg hover:shadow-lg`}
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            ...
            <div className="my-4 md:my-6 rounded-lg">
              <div className="text-sm font-semibold flex justify-end text-red-500">
                <span>{`${sProduct.pQuantity} units left`}</span>
              </div>
                    ...
                    {layoutData.inCart !== null &&
                      ...
                      <>
                        {!isAdmin() ? (<>
                          ...
                          <div
                            onClick={(e) => {
                              history.push("/admin/dashboard/products", { product: { ...productObject }, pId: productObject._id })
                            }}
