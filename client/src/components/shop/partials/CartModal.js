  ...
  return (
    <Fragment>
      ...
      <div
        ...
        } fixed top-0 z-30 w-full h-full`}
      />
      {/* Cart Modal Start */}
      <section
        className={`${
      ...
      >
        <div
          ...
          className="w-full md:w-5/12 lg:w-4/12 h-full flex flex-col  justify-between rounded-l-lg"
        >
          ...
          <div className="m-4 space-y-4">
            <div
              onClick={(e) => cartModalOpen()}
              className="cursor-pointer px-4 py-2 border border-gray-400 text-white text-center cursor-pointer rounded-full"
            >
              Continue shopping
            </div>
            {data.cartTotalCost ? (
              <Fragment>
                {isAuthenticate() ? (
                  <div
                    className="px-4 py-2 bg-black text-white text-center cursor-pointer rounded-full"
                    onClick={(e) => {
              ...
              <div className="px-4 py-2 bg-black text-white text-center cursor-not-allowed rounded-full">
                Checkout
              </div>
            )}
          </div>
